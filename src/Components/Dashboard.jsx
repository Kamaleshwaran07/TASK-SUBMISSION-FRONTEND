  ...
  return user ? (
    <div className="position-relative">
      ...
      {userData.role == "Mentor" ? (
        <Mentor baseURL={baseURL} userData={userData} />
      ) : (
        <Student
          baseURL={baseURL}
          userData={userData}
    ...
    <>
      ...
      <div
        className="text-danger text-uppercase d-flex align-items-center justify-content-center"
        style={{ height: "600px" }}
      >
        <img src={errorimage} width={50} className="mb-2 me-2" alt="error" />{" "}
        UserData not found.{" "}
        <a
