...
const Home = () => {
    return (
            ...
            <div className='d-flex position-relative' style={{height:"90vh"}}>
                <div className='postion-absolute d-flex flex-column' style={{marginTop:"9em", marginLeft:"4em", width:"40%"}}>
                <h5>Welcome to</h5>
                    <h1>Student Task Submission</h1>
                    <h6 className='mt-1 py-3'>Streamline your academic journey with our state-of-the-art task submission system. Designed to simplify the process</h6>
                <Link className='btn border bg-black text-white border-2 w-50' to={'/signup'}>Start submitting</Link>
                </div>
                <div className='position-absolute' style={{marginRight:"5px", right:"2em", marginTop:"3.5em"}} >
                    <img src={heroImage} alt='heroImage' width={"600em"} className='' style={{}} />
                </div>
            
            </div>
            <section className='p-2 row mt-3' style={{marginLeft:"2.5em"}}>
                <figure className='col-6'>
                    <img srcSet={hero2} className='rounded' alt='hero2' width={"500em"} />
                    <figcaption>
                ...
                <aside className='col-6'>
                    ...
                    <figure className='mt-5 p-2 '>
                        <img srcSet={hero3} className='rounded' alt='hero3' width={"500em"} />
                    </figure>
                </aside>
            </section>
            <section className='p-2 row bg-black container-fluid' style={{paddingLeft:"1em"}}>
                <figure className='col-6 ps-5 pt-5'>
                    <img srcSet={hero4} alt='hero2' width={"550em"} />
                   
                  
                </figure>
                <aside className='col-5 py-5 ms-2'>
